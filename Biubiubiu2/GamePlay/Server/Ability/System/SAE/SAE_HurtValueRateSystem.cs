...
namespace Sofunny.BiuBiuBiu2.ServerGamePlay {
    public class SAE_HurtValueRateSystem : S_Ability_Base {
        private AbilityM_HurtValueRate useMData;
        private AbilityIn_HurtValueRate useInData;

        protected override void OnAwake() {
            base.OnAwake();
            useMData = (AbilityM_HurtValueRate)MData;
            if (InData != null) {
                useInData = (AbilityIn_HurtValueRate)InData;
            }
            AddComponents();
        }
        ...
        override protected void AddComponents() {
            ...
            AddComponent<EffectHurtValueRate>( new EffectHurtValueRate.InitData {
                Value = InData != null ? useInData.In_HurtValueRate : useMData.M_HurtValueRate,
            });
