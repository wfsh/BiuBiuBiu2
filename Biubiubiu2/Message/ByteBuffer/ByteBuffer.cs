...
namespace Sofunny.BiuBiuBiu2.Message {
    ...
    public class ByteBuffer : IDisposable {
        ...
        public static ByteBuffer Allocate(int capacity = 512) {
        ...
        private ByteBuffer(int capacity) {
            ...
            this.rawBuffer = new byte[capacity];
        }
        ...
        public void OnWrap(byte[] data) {
            this.isWrap = true;
            this.readIndex = 0;
            this.writeIndex = data.Length;
            this.maxCapacity = data.Length;
            this.rawBuffer = data;
        }
        ...
        public void Write(Quaternion value) {
            // Write(Compression.CompressQuaternion(value));
            EnsureLength(16);
            Write(value.x);
            Write(value.y);
            Write(value.z);
        ...
        public string ReadString() {
            ...
            string result;
            unsafe {
                fixed (byte* bytePtr = rawBuffer) {
                    result = ENCODING.GetString(bytePtr + readIndex, length);
                }
            }
        ...
        public Quaternion ReadQuaternion() {
            ...
            value.z = ReadFloat();
            value.w = ReadFloat();
          //  value = Compression.DecompressQuaternion(ReadUInt());
            return value;
        }
        ...
        private void EnsureLength(int length) {
            int writableLength = maxCapacity - writeIndex;
