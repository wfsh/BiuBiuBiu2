...
namespace Sofunny.BiuBiuBiu2.NetworkMessage {
    public partial class Proto_AbilityAB_Auto {
        public struct Rpc_GoldJokerRocketBombSpawner : IAbilityABCreateRpc {
            public const string ID = "Proto_AbilityAB_Auto.Rpc_GoldJokerRocketBombSpawner";
            public int GetChannel() => NetworkData.Channels.Reliable;
            public string GetID() => ID;
            public ushort GetConfigID() => configId;
            public byte GetRowID() => rowId;
            public const byte FuncID = Rpc_GoldJokerRocketBombSpawner_FuncID;
